...
from sqlalchemy import (
    Column, BIGINT, String, Integer, Enum, TIMESTAMP,
...
class QuotaLog(BaseModel):
    ...
    status = Column(
        Enum(QuotaLogStatus),
        nullable=False,
        default=QuotaLogStatus.SUCCESS,
        index=True,
        comment="状态"
    )
